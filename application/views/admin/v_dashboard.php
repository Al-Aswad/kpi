...
<head>
     ...
     <!-- Morris chart -->
     <link rel="stylesheet" href="<?= base_url('assets_admin/') ?>bower_components/morris.js/morris.css">
     <!-- jvectormap -->
     <link rel="stylesheet" href="<?= base_url('assets_admin/') ?>bower_components/jvectormap/jquery-jvectormap.css">
     <!-- Date Picker -->
     ...
     <link rel="stylesheet" href="<?= base_url('assets_admin/') ?>plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
     ...
     <!-- jQuery UI 1.11.4 -->
     <script src="<?= base_url('assets_admin/') ?>bower_components/jquery-ui/jquery-ui.min.js"></script>
     ...
     <!-- Morris.js charts -->
     <script src="<?= base_url('assets_admin/') ?>bower_components/raphael/raphael.min.js"></script>
     <script src="<?= base_url('assets_admin/') ?>bower_components/morris.js/morris.min.js"></script>
     <!-- Sparkline -->
     ...
     <!-- jQuery Knob Chart -->
     <script src="<?= base_url('assets_admin/') ?>bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
     <!-- daterangepicker -->
